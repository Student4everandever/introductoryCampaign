...
<body>
<a href="/campaign/admin/show_subjects"><fmt:message key="add_subject_back" bundle="${link}"/></a>
<br/>
        ...
        <div class="col-md-12 mb-2 mt-4">
            ...
            <form action="${pageContext.request.contextPath}/campaign/admin/add_subject" method="post"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="name" id="name" placeholder="<fmt:message key="add_subject_enter_subject_name" bundle="${link}"/>"
                           value="" required>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="name_ukr" id="name_ukr"
                           placeholder="<fmt:message key="add_subject_enter_subject_name_ukr" bundle="${link}"/>" value="" required>
                    <div class="invalid-feedback">
                ...
                <hr class="mb-4">
                <input type="submit" class="form-control btn-submit" name="addSubject" value="<fmt:message key="add_subject_add_subject" bundle="${link}"/>">
            </form>
        </div>
    </div>
</div>
