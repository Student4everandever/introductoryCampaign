    ...
    <div class="collapse navbar-collapse ml-4">
        <ul class="navbar-nav">
            ...
            <li class="nav-item active">
                <a href="${pageContext.request.contextPath}/campaign/home"><fmt:message key="header_home" bundle="${link}"/></a>
                <a href="${pageContext.request.contextPath}/campaign/login"><fmt:message key="header_log_in" bundle="${link}"/></a>
                <a href="${pageContext.request.contextPath}/campaign/registration"><fmt:message key="header_registration" bundle="${link}"/></a>
            </li>
        </ul>
    </div>
